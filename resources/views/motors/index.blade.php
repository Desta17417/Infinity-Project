...
<head>
    ...
    <style>
        ...
        .motor-card.slide-from-left {
            transform: translateX(-60px);
        }
        .motor-card.slide-from-right {
            transform: translateX(60px);
        }
        .motor-card.in-view {
            opacity: 1;
...
<body class="bg-gray-50">
    ...
    @foreach($motors as $motor)
        <div class="motor-card bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition {{ $loop->iteration % 2 == 0 ? 'slide-from-right' : 'slide-from-left' }}" style="transition-delay: {{ ($loop->iteration - 1) * 100 }}ms;">
