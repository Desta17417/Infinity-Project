    ...
    <div class="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden mb-8">
        ...
        <div class="bg-slate-50 p-6 space-y-4">
            ...
            <div class="grid grid-cols-2 gap-y-2 text-sm">
                ...
                <span class="text-slate-800 font-semibold text-right">{{ \Carbon\Carbon::parse($rental->tanggal_kembali)->format('d M Y') }}</span>
                
                <span class="text-slate-500">Durasi Sewa:</span>
                <span class="text-slate-800 font-semibold text-right text-blue-600"><strong>{{ $rental->durasi_sewa }} Hari</strong></span>
            </div>
        </div>
    </div>
